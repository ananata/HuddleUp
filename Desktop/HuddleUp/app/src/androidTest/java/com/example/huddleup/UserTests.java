...
public class UserTests {
    ...
    public void userTests() {
        ...
        ViewInteraction appCompatTextView = onView(
                allOf(withId(R.id.title), withText("User"),
                        childAtPosition(
                                childAtPosition(
                                        withId(R.id.content),
                                        0),
        ...
        ViewInteraction actionMenuItemView = onView(
                allOf(withId(R.id.navHome), withText("Home"),
                        childAtPosition(
                                childAtPosition(
                                        withId(R.id.toolbar),
                                        1),
        ...
        ViewInteraction appCompatTextView4 = onView(
                allOf(withId(R.id.title), withText("ProfileIcon"),
                        childAtPosition(
                                childAtPosition(
                                        withId(R.id.content),
                                        0),
        ...
        DataInteraction relativeLayout = onData(anything())
                .inAdapterView(allOf(withId(R.id.GridViewProfileIconSelect),
                        childAtPosition(
                                withId(R.id.ConstraintLayoutForGridView),
                                0)))
                .atPosition(4);
        relativeLayout.perform(click());

        ViewInteraction appCompatButton3 = onView(
                allOf(withId(R.id.ButtonSaveChangesToIcon), withText("Save Changes"),
                        childAtPosition(
                                childAtPosition(
                                        withId(android.R.id.content),
                                        0),
